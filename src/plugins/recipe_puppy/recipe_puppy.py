...
class RecipePuppy(plugins.plugin_base.PluginBase):
  '''
    RecipePuppy(plugins.plugin_base.PluginBase)
  '''
  ...
  def __valid_results_from_redis(self, requested_ingredients):
    '''
      __valid_results_from_redis(requested_ingredients)
    '''
    valid_results = []
    json_dump = None
  ...
  def __store_valid_results_in_redis(
    ...
    '''
      __store_valid_results_in_redis(requested_ingredients, valid_results)
    '''
    redis_key = self.__redis_key(requested_ingredients)
    try:
  ...
  def __results_from_api(self, ingredients, pages):
    '''
      __results_from_api(ingredients, pages)
    '''
    results = []
  ...
  def __response_from_api(self, ingredients, page):
    '''
      __response_from_api(ingredients, page)
    '''
    return requests.get(
        self.api_url,
  ...
  def __valid_results(self, requested_ingredients, raw_results):
    '''
      __valid_results(requested_ingredients, raw_results)
    '''
    valid_results = []
